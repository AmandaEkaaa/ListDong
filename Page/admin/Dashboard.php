  ...
  <ul class="list-unstyled">
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="../../img/pp.jpg" alt="user-image" class="user-avtar">
        <span>Atmin Gacor</span>
      </a>
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="../../img/pp.jpg" alt="user-image" class="user-avtar wid-35">
            </div>
            <div class="flex-grow-1 ms-3">
              <h6 class="mb-1">Atmin Gacor</h6>
              <span>Heker Ganyenk</span>
            </div>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- HAPUS DUPLIKASI INI -->
    <!-- <div class="pc-content"> -->
      <?php include(__DIR__ . '/../../route/admin.php'); ?>
    <!-- </div> -->
  </div>
</div>
<!-- [ Main Content ] end -->
